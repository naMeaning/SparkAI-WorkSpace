...
const remoteDebuggingPort = process.env.NAIMAGE_REMOTE_DEBUGGING_PORT || "";
...
function spawnVite() {
  if (!viteCli) {
    throw new Error("Vite CLI not found. Run pnpm install before starting naimage development mode.");
  }
...
function spawnElectron() {
  ...
  if (!electronCli) {
    throw new Error("Electron CLI not found. Run pnpm install before starting naimage development mode.");
  }
