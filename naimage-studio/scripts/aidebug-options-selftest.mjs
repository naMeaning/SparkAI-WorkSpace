...
const envOptions = parse([], {
  NAIMAGE_AIDEBUG_DEV_PORT: "6211",
  NAIMAGE_REMOTE_DEBUGGING_PORT: "9411",
  NAIMAGE_AIDEBUG_LIVE_IMAGE: "1",
  NAIMAGE_AIDEBUG_REAL_AGENT: "1",
  NAIMAGE_AIDEBUG_LIVE_CONFIG: "1",
  NAIMAGE_AIDEBUG_MOCK_AGENT: "1",
  NAIMAGE_AIDEBUG_CONFIG_DIR: "env-config",
  NAIMAGE_AIDEBUG_AGENT_UI_PROMPT: "env prompt",
  NAIMAGE_AIDEBUG_AGENT_UI_FOLLOWUP: "env followup",
  NAIMAGE_AIDEBUG_AGENT_UI_REFERENCES: "env-a.png|env-b.png",
  NAIMAGE_AIDEBUG_AGENT_UI_SINGLE: "1"
});
assert.deepEqual({
...
const mixedPrecedence = parse([
  ...
  NAIMAGE_AIDEBUG_DEV_PORT: "6333",
  NAIMAGE_REMOTE_DEBUGGING_PORT: "9533",
  NAIMAGE_AIDEBUG_CONFIG_DIR: "env-config",
  NAIMAGE_AIDEBUG_AGENT_UI_PROMPT: "env prompt",
  NAIMAGE_AIDEBUG_AGENT_UI_FOLLOWUP: "env followup",
  NAIMAGE_AIDEBUG_AGENT_UI_REFERENCES: "env.png"
});
...
assert.equal(parse(["--dev-port=", "--port="], { NAIMAGE_AIDEBUG_DEV_PORT: "6444", NAIMAGE_REMOTE_DEBUGGING_PORT: "9644" }).devPort, 6444);
assert.equal(parse(["--dev-port=", "--port="], { NAIMAGE_AIDEBUG_DEV_PORT: "6444", NAIMAGE_REMOTE_DEBUGGING_PORT: "9644" }).debugPort, 9644);
