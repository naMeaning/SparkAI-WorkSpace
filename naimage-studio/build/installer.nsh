...
LangString NAIMAGE_FINISH_TITLE 1033 "naimage is ready"
...
!macro customInstall
  File /oname=naimage-uninstaller.exe "${PROJECT_DIR}\.release-tools\brand-uninstaller\naimage Uninstaller.exe"
