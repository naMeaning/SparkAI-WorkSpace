...
import { Brain, Check, Download, ImageIcon, Plus, RotateCcw, Settings, Shield } from "lucide-react";
...
export default function SettingsDrawer({
  ...
  }, [draftSettings.glassTheme, draftSettings.glassMaterial, draftSettings.glassParameters]);
              ...
              <SurfaceSection className="settings-surface-section settings-canvas-tools-section" aria-labelledby="settings-canvas-tools-heading">
                ...
                <React.Suspense fallback={null}>
                  <LazyCanvasToolsSettingsPanel
                    ...
                    disabledCommands={draftSettings.disabledCanvasToolCommands}
                    onModeChange={(canvasToolDockMode) => update("canvasToolDockMode", canvasToolDockMode)}
                    onDisabledCommandsChange={(disabledCanvasToolCommands) => update("disabledCanvasToolCommands", disabledCanvasToolCommands)}
                  />
                </React.Suspense>
              </SurfaceSection>
              ) : null}
