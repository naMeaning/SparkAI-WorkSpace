...
contextBridge.exposeInMainWorld("naimageConfig", {
  ...
  previewImageCollectionExport: (payload) => ipcRenderer.invoke("naimage:image-collection:export-preview", payload),
  exportImageCollections: (payload) => ipcRenderer.invoke("naimage:image-collection:export", payload),
  openImageCollectionFolder: (payload) => ipcRenderer.invoke("naimage:image-collection:open-folder", payload),
  exportCenterState: (payload) => ipcRenderer.invoke("naimage:export-center:state", payload),
  saveExportCenterPreset: (payload) => ipcRenderer.invoke("naimage:export-center:save-preset", payload),
  deleteExportCenterPreset: (payload) => ipcRenderer.invoke("naimage:export-center:delete-preset", payload),
  recordExportCenterHistory: (payload) => ipcRenderer.invoke("naimage:export-center:record-history", payload),
  clearExportCenterHistory: (payload) => ipcRenderer.invoke("naimage:export-center:clear-history", payload),
  ...
  exportManagedAsset: (payload) => ipcRenderer.invoke("naimage:asset:export-managed", payload),
