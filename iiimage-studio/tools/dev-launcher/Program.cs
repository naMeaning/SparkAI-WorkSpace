...
namespace IiimageStudioDevLauncher;

internal static class Program
{
    private const string DefaultProjectRoot = @"E:\项目\Image\iiimage-studio";
    private const string NodeOverrideVariable = "IIIMAGE_STUDIO_NODE_EXE";
    private static readonly object LogGate = new();

    [STAThread]
    private static void Main()
    {
        var projectRoot = Environment.GetEnvironmentVariable("IIIMAGE_STUDIO_DEV_ROOT")?.Trim();
        ...
        try
        {
            ...
            {
                throw new DirectoryNotFoundException($"未找到 iiimage Studio 开发项目：{projectRoot}");
            }
