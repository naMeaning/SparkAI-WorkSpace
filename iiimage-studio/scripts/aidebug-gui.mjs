...
async function readGuiState(client) {
  return evaluate(client, `(async () => {
    ...
    const modelCacheProbe = window.__iiimageModelCacheProbe || {};
    const agentToolsProbe = window.__iiimageAgentToolsProbe || {};
    ...
    const modelPickerScrollProbe = window.__iiimageModelPickerScrollProbe || {};
    ...
    const agentDebugState = window.__iiimageDebugAgentState?.() || null;
    ...
    const layerPngRuntimeOk = Boolean(
      window.__iiimageLayersProbe?.ok &&
      Number(window.__iiimageLayersProbe?.actionCount || 0) === 1 &&
    ...
    const layerFolderActionVisible = Boolean(
      window.__iiimageLayerMenuProbe?.ok &&
      Array.isArray(window.__iiimageLayerMenuProbe?.texts) &&
      window.__iiimageLayerMenuProbe.texts.some((item) => String(item).includes("打开图层文件夹"))
    );
   ...
   const referenceImageRuntimeOk = Boolean(
     window.__iiimageReferenceProbe?.ok &&
    ...
    const finalImageLayoutGroup = imageLayoutGroups.find((group) => group?.id === window.__iiimageContainerFinalGroupProbe?.group?.id) || imageLayoutGroups[0] || null;
    ...
    const imageLayoutCausalityOk = Boolean(
      window.__iiimageContainerGroupProbe?.causalityPreserved &&
      window.__iiimageContainerDissolveProbe?.causalityPreserved &&
      groupedArtifactNodes.every((node) => !node.parentId && !node.relationType)
    );
    const imageLayoutAutoDissolveOk = Boolean(
      window.__iiimageContainerDissolveProbe?.ok && window.__iiimageContainerDissolveProbe?.groupRemoved
    );
    ...
    const imageContainerRuntimeOk = Boolean(
      window.__iiimageContainerImportProbe?.ok &&
      window.__iiimageContainerImportSettleProbe?.ok &&
      window.__iiimageContainerMoveProbe?.ok &&
      window.__iiimageContainerSplitProbe?.ok &&
      window.__iiimageContainerGroupProbe?.ok &&
      window.__iiimageContainerFinalGroupProbe?.ok &&
    ...
    const canvasImageContainerActionVisible = Boolean(
      Array.isArray(window.__iiimageCanvasMenuProbe?.texts) &&
      ["创建生图工作", "导入图片", "创建图片容器"].every((label) =>
        window.__iiimageCanvasMenuProbe.texts.some((item) => String(item).includes(label))
      )
    );
   const referenceContainerDropOk = Boolean(
     window.__iiimageReferenceDropProbe?.ok &&
     Number(agentDebugState?.referenceImageCount || 0) === 2 &&
     /2\\s*张参考图/.test(text(".project-agent-references"))
   );
   const referenceCapacityNineOk = Number(window.__iiimageReferenceCapacityProbe?.slots || 0) === 9;
   const referencePickerClosedOk = Boolean(
     window.__iiimageReferencePickerCloseProbe?.ok &&
     !document.querySelector('[data-ui-surface="reference-picker"]')
   );
    const imageContainerAgentReferenceOk = Boolean(
      window.__iiimageContainerAgentProbe?.ok === true &&
      window.__iiimageContainerAgentProbe?.roleSet === true &&
      window.__iiimageContainerAgentProbe?.generatedParentId === window.__iiimageContainerGroupProbe?.group?.hostNodeId &&
      Number(window.__iiimageContainerAgentProbe?.referenceImageCount || 0) === 2
    );
    ...
    const imageContainerRuntimeMetrics = {
      ...
      importSettle: window.__iiimageContainerImportSettleProbe || null,
      move: window.__iiimageContainerMoveProbe || null,
      split: window.__iiimageContainerSplitProbe || null,
      group: {
        ok: window.__iiimageContainerGroupProbe?.ok === true,
        targetId: String(window.__iiimageContainerGroupProbe?.targetId || ""),
        sourceId: String(window.__iiimageContainerGroupProbe?.sourceId || ""),
        sourceRetained: window.__iiimageContainerGroupProbe?.sourceRetained === true,
        causalityPreserved: window.__iiimageContainerGroupProbe?.causalityPreserved === true,
        group: window.__iiimageContainerGroupProbe?.group || null,
        drop: compactNativeDropProbe(window.__iiimageContainerGroupProbe)
      },
      agentReference: window.__iiimageContainerAgentProbe || null,
      dissolve: window.__iiimageContainerDissolveProbe || null,
      finalGroup: {
        ok: window.__iiimageContainerFinalGroupProbe?.ok === true,
        group: window.__iiimageContainerFinalGroupProbe?.group || null,
        drop: compactNativeDropProbe(window.__iiimageContainerFinalGroupProbe)
      },
    ...
    const sampleImagePixels = async (image, assetPath = "", samplePolicy = {}) => {
      ...
      let bridgeError = "";
      if (assetPath && window.iiimageConfig?.readAssetDataUrl) {
        try {
          const read = await window.iiimageConfig.readAssetDataUrl({ path: assetPath });
    ...
    const busySupplementClickPathOk = Boolean(window.__iiimageBusySupplementButtonClicked);
    ...
    return {
      ...
      authGateMetrics,
      authLogoutFlowOk: window.__iiimageAuthProbe?.logoutFlowOk === true,
      authLogoutPendingClearedOk: window.__iiimageAuthProbe?.logoutPendingCleared === true,
      authRefreshIsolationOk: window.__iiimageAuthProbe?.refreshIsolationOk === true,
      authRegisterSwitchOk: window.__iiimageAuthProbe?.registerSwitchOk === true,
      authErrorFlowOk: window.__iiimageAuthProbe?.errorFlowOk === true,
      authReloginCleanOk: window.__iiimageAuthReloginProbe?.ok === true,
      authFlowProbe: window.__iiimageAuthProbe || null,
      authReloginProbe: window.__iiimageAuthReloginProbe || null,
      settingsOpen,
      accountOpen,
     ...
     imageContainerAgentReferenceOk,
      ...
      conversationClearIsolationOk: Boolean(window.__iiimageIsolationProbe?.clear?.ok),
      newConversationIsolationOk: Boolean(window.__iiimageIsolationProbe?.conversation?.ok),
      newProjectIsolationOk: Boolean(window.__iiimageIsolationProbe?.project?.ok),
      isolationProbe: window.__iiimageIsolationProbe || null,
      ...
      ctrlNodeSelectionOk: Boolean(window.__iiimageCtrlNodeSelectionProbe?.ok),
      ctrlNodeSelectionProbe: window.__iiimageCtrlNodeSelectionProbe || null,
      multiSelectionStateOk,
      multiSelectionSceneOk: window.__iiimageMultiSelectionSceneProbe?.ok === true,
      multiSelectionSceneMetrics: window.__iiimageMultiSelectionSceneProbe || null,
      canvasLeftPanSelectionOk: Boolean(window.__iiimageCanvasLeftPanProbe?.moved && window.__iiimageCanvasLeftPanProbe?.selectionPreserved),
      stickyMultiSelectionOk: Boolean(window.__iiimageStickySelectionProbe?.ok),
      stickyMultiSelectionProbe: window.__iiimageStickySelectionProbe || null,
      middleMarqueeSelectionOk: Boolean(window.__iiimageMiddleMarqueeSelectionProbe?.ok),
      middleMarqueeSelectionProbe: window.__iiimageMiddleMarqueeSelectionProbe || null,
      prunedMultiSelectionOk: Boolean(window.__iiimageSelectionPruneProbe?.ok),
      selectionPruneProbe: window.__iiimageSelectionPruneProbe || null,
      singleSelectionSwitchOk: Boolean(window.__iiimageSingleSelectionSwitchProbe?.ok),
      singleSelectionSwitchProbe: window.__iiimageSingleSelectionSwitchProbe || null,
      ...
      provenanceConnectionPortRuntimeOk: Boolean(
        window.__iiimageConnectionPortProbe?.ok === true &&
        window.__iiimageConnectionPortProbe?.parentId === (window.__iiimageArtifactSceneIds?.derivedId || "B")
      ),
      provenanceConnectionPortRuntimeMetrics: window.__iiimageConnectionPortProbe || null,
      provenancePortStackingRuntimeOk: window.__iiimageConnectionPortProbe?.stackingHitOk === true,
      ...
      provenanceStablePathRuntimeOk: window.__iiimageEdgeStabilityProbe?.ok === true,
      provenanceStablePathRuntimeMetrics: window.__iiimageEdgeStabilityProbe || null,
      provenanceObstacleNoRerouteRuntimeOk: window.__iiimageEdgeObstacleProbe?.ok === true,
      provenanceObstacleNoRerouteRuntimeMetrics: window.__iiimageEdgeObstacleProbe || null,
      provenanceEdgeCreationOrderRuntimeOk: window.__iiimageEdgeOrderProbe?.creationAndDomOrderOk === true,
      provenanceEdgeCrossingRuntimeOk: window.__iiimageEdgeOrderProbe?.crossingOk === true,
      provenanceEdgeCrossingPaintRuntimeOk: window.__iiimageEdgeOrderProbe?.paintOrderOk === true,
      provenanceEdgeOrderRuntimeMetrics: window.__iiimageEdgeOrderProbe || null,
      selectedNodeZOrderStableOk: window.__iiimageEdgeStabilityProbe?.selectedNodeZOrderStable === true,
      ...
      provenanceSceneViewportOk: window.__iiimageProvenanceSceneProbe?.ok === true,
      provenanceSceneViewportMetrics: window.__iiimageProvenanceSceneProbe || null,
      workflowRelationTypeRuntimeOk: Boolean(
        window.__iiimageRelationTypeProbe?.ok &&
        window.__iiimageRelationTypeProbe?.actionCount === 1 &&
        /relation:\\s*variant/i.test(String(window.__iiimageRelationTypeProbe?.envelope?.visibleOutput || ""))
      ),
      autoImageRelationRuntimeOk: Boolean(
        window.__iiimageAutoImageProbe?.ok &&
        window.__iiimageAutoImageProbe?.actionCount === 1 &&
        agentDebugState?.nodes?.some((node) => node.type === "image" && node.parentId === (window.__iiimageArtifactSceneIds?.sourceId || "A"))
      ),
      ...
      titlebarBrandVisible: visible(".titlebar-brand") && /iiimage Studio/i.test(element(".titlebar-brand")?.textContent || ""),
      workbenchMinWidthOk,
      ...
      manualImageTaskSubmitOk: window.__iiimageManualTaskProbe?.ok === true,
      manualImageTaskProbe: window.__iiimageManualTaskProbe || null,
      ...
      agentBridgeReady: Boolean(window.iiimageAgent?.chat && window.iiimageAgent?.runTool && window.iiimageAgent?.tools && window.iiimageAgent?.onProgress),
      agentDebugReady: Boolean(window.__iiimageDebugSendAgentPrompt && window.__iiimageDebugAgentState),
      agentDebugApiReady: Boolean(window.__iiimageAIDebug?.runSuite && window.__iiimageAIDebug?.runImageSuite && window.__iiimageAIDebug?.runImageRecoverySuite && window.__iiimageAIDebug?.runCanvasImageCollectionSuite && window.__iiimageAIDebug?.runLayerStackSuite && window.__iiimageAIDebug?.runCutoutSuite && window.__iiimageAIDebug?.runRegionRedrawSuite && window.__iiimageAIDebug?.runPosterBatchSuite && window.__iiimageAIDebug?.runMixedStressSuite && window.__iiimageAIDebug?.runTool),
      agentBusy,
      agentRunningUiOk,
...
async function captureAgentImageSuiteProbe(client, targetId, runs = imageRuns) {
  ...
  await setWindowSize(client, targetId, 1280, 820);
  await evaluate(client, `window.__iiimageDebugOpenSurface?.("main")`);
  await waitForExpression(client, "Boolean(window.__iiimageAIDebug?.runImageSuite && window.__iiimageDebugAgentState)", 10000);
  recordObservation("info", "agent-image-suite-request", {
    runs,
    prompt: "AIDebug 连续执行真实 image_gen 生图任务并观察节点布局。"
  });
  const suite = await evaluate(client, `window.__iiimageAIDebug.runImageSuite({ runs: ${Number(runs)} })`, suiteTimeoutMs);
...
async function captureAgentImageRecoverySuiteProbe(client, targetId) {
  ...
  await setWindowSize(client, targetId, 1280, 820);
  await evaluate(client, `window.__iiimageDebugOpenSurface?.("main")`);
  await waitForExpression(client, "Boolean(window.__iiimageAIDebug?.runImageRecoverySuite && window.__iiimageDebugAgentState)", 10000);
  ...
  const suite = await evaluate(client, `window.__iiimageAIDebug.runImageRecoverySuite()`, suiteTimeoutMs);
...
async function captureCanvasImageCollectionSuiteProbe(client, targetId, options = {}) {
  ...
  await setWindowSize(client, targetId, 1280, 820);
  await evaluate(client, `window.__iiimageDebugOpenSurface?.("main")`);
  await waitForExpression(client, "Boolean(window.__iiimageAIDebug?.runCanvasImageCollectionSuite && window.__iiimageDebugAgentState)", 10000);
  recordObservation("info", "canvas-image-collection-suite-request", {
    liveImage,
    prompt: "验证标准单图、连续三图、并行十图、不同提示词图片组、画布内部归组、明确另存为和继续生成的真实闭环。"
  });
  const suite = await evaluate(client, `window.__iiimageAIDebug.runCanvasImageCollectionSuite()`, suiteTimeoutMs);
  ...
  await evaluate(client, `window.__iiimageAIDebug.selectNode({ id: ${JSON.stringify(String(suite?.ids?.seriesId || ""))} })`);
  ...
  await evaluate(client, `window.__iiimageAIDebug.selectNode({ id: ${JSON.stringify(String(suite?.ids?.batchId || ""))} })`);
  ...
  const viewerOpen = await evaluate(
    client,
    `window.__iiimageAIDebug.openImageViewer({ id: ${JSON.stringify(String(suite?.ids?.batchId || ""))}, index: 4 })`
  );
  ...
  const normalEditorOpen = await evaluate(
    client,
    `window.__iiimageAIDebug?.openNodeEditor?.({ id: ${JSON.stringify(String(suite?.ids?.singleId || ""))}, index: 0 })`
  );
  await waitForExpression(client, "Boolean(window.__iiimageDebugAgentState?.().nodeEditorOpen)", 5000);
  const normalEditorSpaceProof = await evaluate(client, `window.__iiimageDebugAgentState?.().nodeEditorUi?.spaceUse || null`);
  ...
  await waitForExpression(client, "Boolean(window.__iiimageDebugAgentState?.().nodeEditorOpen)", 5000);
  const compactNormalEditorSpaceProof = await evaluate(client, `window.__iiimageDebugAgentState?.().nodeEditorUi?.spaceUse || null`);
...
async function capturePerformanceSuiteProbe(client, targetId) {
  ...
  const rendererMetrics = await evaluate(client, `(async () => {
    ...
    const performanceState = () => window.__iiimageAIDebug?.performanceState?.() || window.__iiimageDebugAgentState?.() || {};

    window.__iiimageDebugOpenSurface?.('main');
    window.__iiimageDebugApplyAgentActions?.([{ type: 'workflow.canvas.clear', mode: 'all' }]);
    await nextFrames(3);
    await delay(420);
    window.__iiimageAIDebug?.resetPersistenceMetrics?.();
    window.__iiimageAIDebug?.resetRenderCommits?.();
    const nodes200Phase = beginPhase('nodes200');
    const hydrateStartedAt = performance.now();
    const hydrateAccepted = window.__iiimageDebugApplyAgentActions?.(${JSON.stringify(nodeActions)});
    ...
    const nodes200RenderCommits = window.__iiimageAIDebug?.renderCommits?.() || null;
    const nodes200 = {
    ...
    for (let index = 0; index < 8; index += 1) {
      const accepted = window.__iiimageDebugApplyAgentActions?.([{
    ...
    await delay(760);
    const automaticPersistenceMetrics = window.__iiimageAIDebug?.persistenceMetrics?.() || null;
    const largeProjectLoadStartedAt = performance.now();
    const largeProjectLoaded = await window.iiimageConfig?.loadSession?.();
    ...
    const largeProjectSaved = largeProjectLoaded?.ok && loadedNodeCount === 200
      ? await window.iiimageConfig?.saveSession?.({
    ...
    const interactionRenderCommits = window.__iiimageAIDebug?.renderCommits?.() || null;
    ...
    const nodes1000Accepted = window.__iiimageDebugApplyAgentActions?.(nodes1000Actions);
    const nodes1000Wait = await waitFor(() => Number(performanceState().nodeCount || 0) === 1000, 30000, '1000-node hydrate');
    const selectedLast = await window.__iiimageAIDebug?.selectNode?.({ id: 'aidebug-performance-node-1000-1000' });
    await nextFrames(4);
    ...
    const selectedLastVisibleRatio = selectedLastBox
      ...
      : 0;
    const nodes1000RenderCommits = window.__iiimageAIDebug?.renderCommits?.() || null;
    const nodes1000 = {
    ...
    window.__iiimageDebugOpenSurface?.('agent-timeline');
    window.__iiimageDebugSeedAgentMessages?.({ clear: true });
    await nextFrames(3);
    window.__iiimageAIDebug?.resetRenderCommits?.();
    ...
    const longTimelineAccepted = window.__iiimageDebugSeedAgentMessages?.({ messages: timelineMessages, append: false, maxMessages: 500 });
    ...
    const longTimelineRenderCommits = window.__iiimageAIDebug?.renderCommits?.() || null;
    const longTimeline = {
    ...
    window.__iiimageDebugSeedAgentMessages?.({
    ...
    for (let index = 1; index <= 1000; index += 1) {
      ...
      const accepted = window.__iiimageDebugSeedAgentMessages?.({
        streamDelta: {
    ...
    const streamingRenderCommits = window.__iiimageAIDebug?.renderCommits?.() || null;
    ...
    const thumbnailStatsReset = await window.iiimageConfig?.thumbnailStats?.({ reset: true });
    ...
    const containerAccepted = window.__iiimageDebugApplyAgentActions?.([{
      type: 'workflow.node.create',
    ...
    await nextFrames(2);
    const imageContainerRenderCommits = window.__iiimageAIDebug?.renderCommits?.() || null;
    const coldThumbnailStatsResult = await window.iiimageConfig?.thumbnailStats?.();
    ...
    await window.iiimageConfig?.thumbnailStats?.({ reset: true });
    ...
    const warmThumbnailStatsResult = await window.iiimageConfig?.thumbnailStats?.();
    ...
    const saved = loaded?.ok && loaded.session
      ? await window.iiimageConfig?.saveSession?.({ ...loaded.session, projectId: loaded.activeProjectId || loaded.project?.id || 'default' })
      : null;
    const save = {
  ...
  const thumbnailCacheDir = join(aidebugConfigDir, "projects", "default", ".iiimage", "thumbnails");
  ...
  const containerObserved = await evaluate(client, `({
    runtimeNodeCount: Number(window.__iiimageDebugAgentState?.().nodeCount || 0),
  ...
  const nodes1000Capture = await captureState(
    ...
    `(async () => {
      ...
      const accepted = window.__iiimageDebugApplyAgentActions?.(actions);
      const startedAt = Date.now();
      while (Date.now() - startedAt < 30000 && Number(window.__iiimageDebugAgentState?.().nodeCount || 0) !== 1000) await new Promise((resolve) => requestAnimationFrame(resolve));
      const selected = await window.__iiimageAIDebug?.selectNode?.({ id: 'aidebug-performance-visual-node-1000' });
  ...
  const longTimelineCapture = await captureState(
    ...
    `(async () => {
      ...
      const accepted = window.__iiimageDebugSeedAgentMessages?.({ messages, append: false, maxMessages: 500 });
      const startedAt = Date.now();
      while (Date.now() - startedAt < 12000 && (Number(window.__iiimageDebugAgentState?.().messageCount || 0) !== 500 || document.querySelectorAll('.project-agent-feed .agent-message').length !== 80)) await new Promise((resolve) => requestAnimationFrame(resolve));
      const feed = document.querySelector('.project-agent-feed');
      if (feed) feed.scrollTop = feed.scrollHeight;
      await new Promise((resolve) => setTimeout(resolve, 450));
      if (feed) feed.scrollTop = Number.MAX_SAFE_INTEGER;
  ...
  const longTimelineObserved = await evaluate(client, `(() => {
    const feed = document.querySelector('.project-agent-feed');
    return {
      runtimeMessageCount: Number(window.__iiimageDebugAgentState?.().messageCount || 0),
      domMessageCount: document.querySelectorAll('.project-agent-feed .agent-message').length,
  ...
  const streamingCapture = await captureState(
    ...
    `(async () => {
      window.__iiimageDebugOpenSurface?.('agent-timeline');
      window.__iiimageDebugSeedAgentMessages?.({ messages: [{ id: 'aidebug-performance-visual-stream', role: 'assistant', content: 'STREAM_BEGIN|', status: 'running', meta: 'performance-streaming-visual' }], append: false, maxMessages: 1 });
      await new Promise((resolve) => requestAnimationFrame(() => requestAnimationFrame(resolve)));
      for (let index = 1; index <= 1000; index += 1) {
        const delta = 'D' + String(index).padStart(4, '0') + (index === 1000 ? '|STREAM_END_1000' : '|');
        window.__iiimageDebugSeedAgentMessages?.({ streamDelta: { id: 'aidebug-performance-visual-stream', delta, status: index === 1000 ? 'done' : 'running' } });
  ...
  const cleanupRendererMetrics = await evaluate(client, `(async () => {
    ...
    return {
      cleanupState,
      renderCommits: window.__iiimageAIDebug?.renderCommits?.() || null,
...
async function main() {
  ...
  try {
    ...
    if (performanceSuiteOnly) {
      results.push(...await capturePerformanceSuiteProbe(client, target.id));
