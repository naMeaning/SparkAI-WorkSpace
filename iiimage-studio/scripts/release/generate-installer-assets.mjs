...
const iconSource = join(projectRoot, "public", "iiimage-studio.png");
const windowsIconSource = join(projectRoot, "assets", "windows", "iiimage-studio.ico");
...
<svg xmlns="http://www.w3.org/2000/svg" width="164" height="314" viewBox="0 0 164 314">
  ...
  <text x="18" y="150" fill="#f4fffc" font-family="Segoe UI, Microsoft YaHei, sans-serif" font-size="18" font-weight="720">iiimage Studio</text>
...
<svg xmlns="http://www.w3.org/2000/svg" width="150" height="57" viewBox="0 0 150 57">
  ...
  <text x="12" y="23" fill="#0c2a37" font-family="Segoe UI, Microsoft YaHei, sans-serif" font-size="12.5" font-weight="720">iiimage Studio</text>
...
copyFileSync(windowsIconSource, join(buildDir, "iiimage-studio.ico"));
await Promise.all([
...
console.log(JSON.stringify({
  icon: join(buildDir, "iiimage-studio.ico"),
