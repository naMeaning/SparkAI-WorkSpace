    ...
    performance: {
      ...
      fixtures: {
        ...
        imageContainer10: {
          ...
          canvasImageSources: Array.from({ length: 10 }, (_, index) => `iiimage-asset://fixture-${index}.png?preview=thumbnail&max=512`),
          canvasNaturalSizes: Array.from({ length: 10 }, () => ({ width: 512, height: 288 })),
          viewerMainSource: "iiimage-asset://fixture-0.png",
          viewerStripSources: ["iiimage-asset://fixture-0.png?preview=thumbnail&max=512"],
...
function runAudit(report) {
  const directory = mkdtempSync(join(tmpdir(), "iiimage-performance-audit-"));
