...
func migrateDB() error {
	...
	err := DB.AutoMigrate(
		...
		&UserOAuthBinding{},
		&PerfMetric{},
		&ManagedImageIdempotencyRecord{},
		&NaimageActivationCode{},
		&NaimageActivationGrant{},
		&SystemInstance{},
		&SystemTask{},
		&SystemTaskLock{},
		&CasbinRule{},
...
func migrateDBFast() error {
	...
	migrations := []struct {
		...
		{&ManagedImageIdempotencyRecord{}, "ManagedImageIdempotencyRecord"},
		{&NaimageActivationCode{}, "NaimageActivationCode"},
		{&NaimageActivationGrant{}, "NaimageActivationGrant"},
