    ...
    <Sonner
      ...
      toastOptions={{
        ...
        classNames: {
          ...
          toast: cn('max-sm:!pr-12', toastOptions?.classNames?.toast),
          closeButton: cn(
            '!top-1/2 !right-2 !left-auto !size-10 !translate-x-0 !-translate-y-1/2 !rounded-full !border-transparent !bg-transparent !shadow-none hover:!bg-background/20 sm:!size-6',
