  ...
  return (
    <>
      <header className='pointer-events-none fixed inset-x-0 top-0 z-50'>
        <div
          className={cn(
            'pointer-events-auto mx-auto w-full transition-all duration-700 ease-[cubic-bezier(0.16,1,0.3,1)]',
            scrolled ? 'max-w-[52rem] px-3 pt-3' : 'max-w-7xl px-4 pt-0 md:px-6'
          )}
        >
          <nav
            className={cn(
              'relative flex w-full min-w-0 items-center justify-between transition-all duration-700 ease-[cubic-bezier(0.16,1,0.3,1)]',
              scrolled
          ...
          >
            ...
            >
              <div className='flex size-7 shrink-0 items-center justify-center transition-all duration-300 group-hover:scale-105'>
                {customLogo ?? <SiteLogoMark className='size-7' />}
              </div>
              ...
              {showAuthButtons && (
                <>
                  ...
                  {isAuthenticated ? (
                    ...
                    <Button
                      size='sm'
                      className='h-10 rounded-lg px-3.5 text-xs font-medium sm:h-8'
            ...
            <div className='absolute top-1/2 right-2 flex -translate-y-1/2 items-center gap-2 sm:hidden'>
              {showThemeSwitch && <ThemeSwitch />}
