...
function buildDetailSegments(
  ...
  if (isTieredExpr) {
    ...
    const isPerCall =
      typeof modelPrice === 'number' && isPerCallBilling(modelPrice)
    if (isPerCall) {
      segments.push({
                  ...
                  <div className='relative inline-flex w-fit items-center gap-1'>
                    ...
                    {affinity && (
                      <Button
                        ...
                        variant='ghost'
                        size='icon-sm'
                        className='rounded-full text-amber-500 hover:text-amber-500'
        ...
        cell: function UserCell({ row }) {
          ...
          return (
            <Button
              ...
              variant='ghost'
              size='sm'
              className='max-w-[160px] justify-start px-1 text-left'
              onClick={(e) => {
                e.stopPropagation()
        ...
        return (
          <>
            <Button
              ...
              variant='ghost'
              size='sm'
              className='group max-w-[200px] justify-start px-1 text-left text-xs'
