...
const URL_TO_CONFIG_MAP: Record<string, { section: string; module: string }> = {
  ...
  '/wallet': { section: 'console', module: 'wallet' },
  '/profile': { section: 'console', module: 'profile' },
...
function parseUserSidebarConfig(
  ...
  try {
    ...
    const sanitized: SidebarModulesAdminConfig = {}
    Object.entries(parsed).forEach(([sectionKey, sectionConfig]) => {
      if (sectionKey === 'chat') return
      if (sectionKey === 'personal') return
